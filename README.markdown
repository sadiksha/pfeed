...
<pre>
<code>
 $ rails plugin install git://github.com/sadiksha/pfeed.git # or use script/plugin for older version of rails previously it was git://github.com/parolkar/pfeed.git
 $ rake pfeed:setup
</code>
</pre>
